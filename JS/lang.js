(function () {
  ...
  const dict = {
    az: {
      ...
      preparedDate: "Hazırlanma tarixi: 18.09.2026",
      presentation: "Təqdimat",
      participants: "İştirakçılar:",
      copyright: "Şifahi Hesablama. Bütün hüquqlar qorunur.",
      correct: "Düzgündür!",
      wrong: "Səhv cavab!",
      timeUp: "Vaxt bitdi!",
      result: "Nəticə",
    ...
    en: {
      ...
      preparedDate: "Date of preparation: 18.09.2026",
      presentation: "Presentation",
      participants: "Participants:",
      copyright: "Mental Math. All rights reserved.",
      correct: "Correct!",
      wrong: "Wrong answer!",
      timeUp: "Time's up!",
      result: "Result",
    ...
    ru: {
      ...
      preparedDate: "Дата подготовки: 18.09.2026",
      presentation: "Презентация",
      participants: "Участники:",
      copyright: "Устный счёт. Все права защищены.",
      correct: "Верно!",
